    ...
    <div className="container__main">
      ...
      <div className="container__main_center">
        ...
        <div>
          <div>
            <img src="https://pbs.twimg.com/profile_images/1275465924880015360/zh_8s1x2_normal.jpg" alt="imgProfile" />
            <label htmlFor="input_whats">
              <input type="text" id="input_whats" placeholder="What's going on?" />
            </label>
          </div>
          <div>
            <img src="https://pbs.twimg.com/profile_images/1275465924880015360/zh_8s1x2_normal.jpg" alt="imgProfile" />
      ...
      {/* RIGHT SECTION */}
      <div className="container__main_right">ASIDE_RIGHT</div>
    </div>
  )
}
