...
const HomeLeftSvgs = ({ username }) => (
  <>
    <ul className="home__list">
            ...
            <p className="p__bold">
              <svg viewBox="0 0 24 24" aria-hidden="true" className="login__main_home--icons withoutFilter" alt="registerSvg">
                <g fill="rgba(29,161,242,1.00)">
                  ...
                  <path d="M8.22 12.184c0 2.084 1.695 3.78 3.78 3.78s3.78-1.696 3.78-3.78-1.695-3.78-3.78-3.78-3.78 1.696-3.78 3.78zm6.06 0c0 1.258-1.022 2.28-2.28 2.28s-2.28-1.022-2.28-2.28 1.022-2.28 2.28-2.28 2.28 1.022 2.28 2.28z" />              </g>
              </svg>
            </p>
          </Link>
      }
      ...
      <p>
        <svg viewBox="0 0 24 24" aria-hidden="true" className="login__main_home--icons orderToDisappear1" alt="registerSvg">
          <g fill="rgba(217, 217, 217, 0.3)">
      ...
      <p>
        <svg viewBox="0 0 24 24" aria-hidden="true" className="login__main_home--icons orderToDisappear2" alt="registerSvg">
          <g fill="rgba(217, 217, 217, 0.3)" width="30px">
      ...
      <p>
        <svg viewBox="0 0 24 24" aria-hidden="true" className="login__main_home--icons orderToDisappear3" alt="registerSvg">
          <g fill="rgba(217, 217, 217, 0.3)">
      ...
      <p>
        <svg viewBox="0 0 24 24" aria-hidden="true" className="login__main_home--icons orderToDisappear4" alt="registerSvg">
          <g fill="rgba(217, 217, 217, 0.3)">
      ...
      <p>
        <svg viewBox="0 0 24 24" aria-hidden="true" className="login__main_home--icons orderToDisappear5" alt="registerSvg">
          <g fill="rgba(217, 217, 217, 0.3)">
      ...
      <p className="home__last_margin">
        <svg viewBox="0 0 24 24" aria-hidden="true" className="login__main_home--icons" alt="registerSvg">
          <g fill="rgba(217, 217, 217, 0.3)">
...
export default connect(mapStateToProps, null) (HomeLeftSvgs)
