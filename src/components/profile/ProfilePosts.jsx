function ProfilePosts(props) {
    const { res } = props
    return (
        <div className="Home__center_whatprofile-input" id={ res.id } >
              <div className="Home__center_topTweetText">
                <div>
                  <span className="Home__center_TextProfile">{res.author}</span>
                  <span className="Home__center_TextUsername">@{res.author}</span>
                  <span className="Home__center_Dot">·</span>
                  <span className="Home__center_Time">{ res.created_on }</span>
                </div>
                <div>
              ...
              <div>
                <figure className="Home__center_figcapTweet">
                  <figcaption>{ res.body }</figcaption>
                  {/* { image === null ? <img className="Home__center_imgTweet" src= alt="imgtesting" style={{display: 'none'}} /> : <img className="Home__center_imgTweet" src= alt="imgtesting" /> } */}
                  <img className="Home__center_imgTweet" src="https://media.timeout.com/images/105240237/image.jpg" alt="imgtesting" />
                </figure>
              </div>
